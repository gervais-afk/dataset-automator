...
async def lifespan(app: FastAPI):
    ...
    try:
        model_file_local = "pipeline_diabetes_data_upload_20260718_1728.joblib"
        ...
        if os.path.exists(local_path):
            ...
            model_path = "C:/Users/HP/cam_data_sov_solutions newversion/dataset_automator/workspace/outputs/diabetes_data_upload/outputs/diabetes_data_upload/models/pipeline_diabetes_data_upload_20260718_1728.joblib"
            if os.path.exists(model_path):
                ml_models["regression_model"] = load_model(model_path)
            else:
                rel_path = os.path.join(os.path.dirname(__file__), "..", "models", "pipeline_diabetes_data_upload_20260718_1728.joblib")
...
app = FastAPI(
    title="API de Prediction - diabetes_data_upload",
