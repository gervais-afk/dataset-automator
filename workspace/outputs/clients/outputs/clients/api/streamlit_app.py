...
st.set_page_config(
    page_title="Inference clients - MLOps", 
    page_icon="🎯", 
    layout="wide",
...
num_cols = ['client_id', 'anciennete_mois', 'age', 'region', 'type_offre', 'moyen_paiement', 'conso_data_go', 'conso_voix_min', 'conso_sms', 'nb_contacts_support', 'nb_incidents_reseau', 'churn']
cat_cols = []
features_input = {}
